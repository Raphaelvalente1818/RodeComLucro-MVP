...
**Tudo que estava pendente desta sessão (08/09 e 10/09) está fechado**: aba Saúde do sistema, instrumentação de erro, trial de cálculo via WhatsApp com CTA de cadastro, e o deploy de todas as 4 functions. Próximo passo natural seria testar de verdade mandando uma mensagem pro WhatsApp de um número não cadastrado, pra confirmar o fluxo ponta a ponta — mas isso depende do Raphael (ou de alguém) mandar a mensagem de teste.
